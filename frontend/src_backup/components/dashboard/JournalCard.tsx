    ...
    >
      <div className="flex items-center justify-between mb-5">
        ...
        <button
          ...
          className="text-xs text-violet-500 font-medium hover:text-violet-700 transition-colors flex items-center gap-1"
        >
      ...
      <button
        onClick={() => navigate("/journal")}
        className="mt-4 w-full py-2.5 rounded-2xl border-2 border-dashed border-violet-200 text-sm text-violet-500 font-medium hover:bg-violet-50 hover:border-violet-300 transition-all duration-200 flex items-center justify-center gap-2"
      >
        <PenLine size={14} />
        Write today's entry
      </button>
